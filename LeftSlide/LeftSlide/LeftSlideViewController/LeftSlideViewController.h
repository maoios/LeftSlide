...
//第一种方式的时候tableview定住不滑动，你侧边足够显示你的菜单，顶部的view久当作tableview的headview，此时顶部距离0，如果菜单需要滑动，那么顶部的view要分开写，此时顶部距离自己根据需要调整
#define TopHeight 150 //顶部距离
#define BottomHeight 60 //低部距离
